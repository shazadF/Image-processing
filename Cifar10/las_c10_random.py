...
def load_data():
    ...
    # as we have total 50000 train & 10000 test images
    rndm20train = np.random.randint(0,50000,20)
    X_train = x[rndm20train,:,:,:]

    Y_train = y[rndm20train]
    ...
    rndm20test = np.random.randint(50001,60000,20)
    X_test = x[rndm20test,:,:,:]
    Y_test = y[rndm20test]
