...
def making_x_plots ():
	clean_lines = []
	os.chdir(r'/home/forhad/Desktop/GitAll/bit/Plot_Image/Graph')
   	file = open('cifar10_ica_uni.txt')
	...
	patFinder = re.compile('val_loss: \d\.\d\d\d\d', re.IGNORECASE)
...
def making_y_plots ():
	...
	patFinder = re.compile(' loss: \d\.\d\d\d\d', re.IGNORECASE)
