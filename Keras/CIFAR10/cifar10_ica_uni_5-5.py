...
new_array = new_array.reshape( new_array.shape[0],75)
...
new_xshape = norm.reshape(75,3,5,5)
# print (new_xshape)
# print("------------", new_xshape.shape)
...
model.add(Convolution2D(75, 5, 5, border_mode='same',
