...
#calculationg z-score
mean = np.mean(data_set)
print("Mean is: ",mean)
stdev = np.std(data_set)
print("Standerd Deviation is:", stdev)

zscore = (data_set - mean)/stdev
print("Zscore value is:", zscore)

#applying zscore in individual patch
zscore_data = []
for i in range(0,32):
        ...
        zscore1 = (patch - mean1)/stdev
        print("Individual zscore:", zscore1.shape)
        zscore_data.append(zscore1)

zscore_data = np.asarray(zscore_data)
new_shape = np.asarray(zscore_data)
# print(new_shape)
